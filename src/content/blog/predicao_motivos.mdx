...
## Técnicas de Previsão e Detecção de Motivos

Vários métodos computacionais foram desenvolvidos para prever e detectar motivos em sequências biológicas. Algumas técnicas utilizadas são:
...
2. Position Weight Matrices (PWMs) - Matrizes de peso de posição
